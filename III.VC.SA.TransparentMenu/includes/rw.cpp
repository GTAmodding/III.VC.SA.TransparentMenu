...
//static uint32_t RpMatFXAtomicEnableEffects_A = AddressByVersion<uint32_t>(0, 0x657020);
//WRAPPER RpAtomic *RpMatFXAtomicEnableEffects(RpAtomic*) { VARJMP(RpMatFXAtomicEnableEffects_A); }
...
//static uint32_t RpGeometryForAllMaterials_A = AddressByVersion<uint32_t>(0, 0x64CC90);
//WRAPPER RpGeometry *RpGeometryForAllMaterials(RpGeometry*, RpMaterialCallBack, void*) { VARJMP(RpGeometryForAllMaterials_A); }